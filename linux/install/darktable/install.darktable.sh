#!/usr/bin/env bash
# Description: Install and configure Darktable
...
Description:
  Installs Darktable photography workflow application via Flatpak.
...
echo "[✓] Darktable installation completed successfully!"
