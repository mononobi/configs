#!/usr/bin/env bash
# Description: Install and configure Thonny
...
Description:
  Installs Thonny Python IDE via Flatpak.
...
is_installed "org.thonny.Thonny" --type flatpak --name "Thonny" && exit 0
...
echo "[✓] Thonny installation completed successfully!"
